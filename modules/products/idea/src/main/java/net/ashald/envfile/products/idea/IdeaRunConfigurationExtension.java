...
public class IdeaRunConfigurationExtension extends RunConfigurationExtension {
     ...
     */
    @Override
    public <T extends RunConfigurationBase<?>> void updateJavaParameters(@NotNull T configuration, @NotNull JavaParameters params, RunnerSettings runnerSettings, @NotNull Executor executor) throws ExecutionException {
       this.updateJavaParameters(configuration, params, runnerSettings);
    }
    //
