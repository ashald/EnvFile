package com.cmmoran.envfile.platform.ui;
...
import com.cmmoran.envfile.platform.EnvFileEntry;
import com.cmmoran.envfile.platform.EnvFileSettings;
import com.cmmoran.envfile.platform.EnvVarsProviderExtension;
import com.cmmoran.envfile.platform.ui.table.EnvFileIsActiveColumnInfo;
import com.cmmoran.envfile.platform.ui.table.EnvFileIsExecutableColumnInfo;
import com.cmmoran.envfile.platform.ui.table.EnvFilePathColumnInfo;
import com.cmmoran.envfile.platform.ui.table.EnvFileTypeColumnInfo;
import com.cmmoran.envfile.providers.runconfig.RunConfigEnvVarsProvider;
...
class EnvFileConfigurationPanel<T extends RunConfigurationBase<?>> extends JPanel {
  ...
  EnvFileConfigurationPanel(T configuration) {
    ...
    useEnvFileCheckBox.addActionListener(e -> {
